...
public class RedFront4Sample extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        int zeroArmPos = arm.getCurrentPosition();
        telemetry.addData("CurrentArmPos", zeroArmPos);

        ReadWrite.writeToFile(zeroArmPos,"ZeroArmPos.txt");
        ...
        ReadWrite.writeToFile(armSlider.getCurrentPosition(),"ZeroArmSliderPos.txt");
        ...
        Action wait08Second = drive.actionBuilder(beginPose)
                .waitSeconds(0.8)
                .build();
        ...
        Action turnToBlock1 = drive.actionBuilder(new Pose2d(-48, -48, Math.toRadians(225)))
                //.waitSeconds(0.25)
                .strafeToLinearHeading(new Vector2d(-44, -40.3), Math.toRadians(90), new TranslationalVelConstraint(60))
                .build();


        Action moveToBasket2 = drive.actionBuilder(new Pose2d(-44,-40.3,Math.toRadians(90)))
                .strafeToLinearHeading(new Vector2d(-52.5, -52.5), Math.toRadians(225))
                .build();
        ...
        Action turnToBlock2 = drive.actionBuilder(new Pose2d(-50, -50, Math.toRadians(225)))
                .strafeToLinearHeading(new Vector2d(-55, -41), Math.toRadians(90), new TranslationalVelConstraint(65))//-55.6
                .build();


        Action moveToBasket3 = drive.actionBuilder(new Pose2d(-55,-41,Math.toRadians(90)))
                .strafeToLinearHeading(new Vector2d(-52.5, -52.5), Math.toRadians(225))
                .build();
        ...
        Action turnToBlock3 = drive.actionBuilder(new Pose2d(-48, -48, Math.toRadians(225)))
                .strafeToLinearHeading(new Vector2d(-55, -37),Math.toRadians(124), new TranslationalVelConstraint(65))
                .build();

        Action moveToBasket4 = drive.actionBuilder(new Pose2d(-55,-37,Math.toRadians(124)))
                .strafeToLinearHeading(new Vector2d(-52.5, -52.5), Math.toRadians(225))
                .build();

        Action moveForwardBasket4 = drive.actionBuilder(new Pose2d(-52.5,-52.5,Math.toRadians(225)))
                .strafeTo(new Vector2d(-55.5,-55.5))
                .build();

        Action moveBackBasket4 = drive.actionBuilder(new Pose2d(-55.5,-55.5,Math.toRadians(225)))
                .waitSeconds(0.2)
                .strafeTo(new Vector2d(-50,-50))
                .build();
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        new SequentialAction(
                                new ArmAction(arm, armSlider, -1015,0.01),
                                wait1Second,
                                turnToBlock1,
                                new ArmSliderAction(armSlider,560,1),
                                new ArmClawAction(armClaw,0.92),
                                wait08Second,
                                new ArmSliderAction(armSlider,-460,1)

                                ),
                        new ParallelAction(
                                moveToBasket2,
                                new ArmAction(arm, armSlider,910,1)

                        ),
                        //go to basket with 2nd block
                        new SequentialAction(
                                new ArmSliderAction(armSlider,2025,1),//2370
                                ...
                                wait08Second,
                                new ArmClawAction(armClaw,0.5),
                                new ArmAction(arm, armSlider,80,1),
                                moveBackBasket2,
                        ...
                        new SequentialAction(
                                ...
                                new ArmSliderAction( armSlider, 855, 1),//875
                                wait1Second,
                                new ArmClawAction(armClaw,0.92),
                                wait08Second,
                                new ArmSliderAction(armSlider,-705,1)
                        ...
                        new SequentialAction(
                                ...
                                wait1Second,
                                new ArmClawAction(armClaw,0.43),
                                wait1Second,
                                new ArmAction(arm, armSlider,90,1),
                                moveBackBasket3,
                                //here onwards is block 4
                                new ArmSliderAction(armSlider, -2325,1)

                        ),
                        new SequentialAction(

                                new ArmAction(arm, armSlider, -990,0.005),
                                turnToBlock3,
                                wait1Second,
                                new ArmSliderAction( armSlider, 875, 1),//935
                                wait1Second,
                                new ArmClawAction(armClaw,0.92),
                                new ArmSliderAction(armSlider,-705,1)
                        ),
                        new ParallelAction(
                                moveToBasket4,
                                new ArmAction(arm, armSlider,920,1)
